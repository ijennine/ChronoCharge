...
/**
 * Activité qui permet d'afficher le niveau de batterie
 */
public class BatteryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Envoi du signal intent grace au broadcast
    ...
    /**
     * Classe qui permet de recevoir un signal intent en broadcast à chaque écheance de niveau
     * de lecture de la battérie
     */
