...
/**
 * L'activité principale dans laquelle nous permoettons à l'utilisateur de pouvoir se connecter
 * au périphérique BT
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private ListView.OnItemClickListener deviceListListener = new ListView.OnItemClickListener() {
        @Override
        public void onItemClick(AdapterView<?> adapter, View view, int arg2, long rowId) {
